...
//    View ViewCenter;
//    //		CheckedTextView checkBoxcalendar_day_gridcell;
...
//            if(Integer.parseInt(formattedDate.split("-")[2].toString())>=yy){
...
//        String date_month_year = (String) relative.getTag();
...
//        SimpleDateFormat df = new SimpleDateFormat("dd-MM-yyyy");
//        String formattedDate = df.format(c.getTime());
//        if (Integer.parseInt(formattedDate.split("-")[2].toString()) <= Integer.parseInt(date_month_year.split("-")[2].toString())) {
//            if (Integer.parseInt(formattedDate.split("-")[1].toString()) == Integer.parseInt(formattedDate1.split("-")[1].toString())) {
//                if (Integer.parseInt(formattedDate.split("-")[0].toString()) < Integer.parseInt(date_month_year.split("-")[0].toString())) {
//                    gridcell.setTextColor(Color.WHITE);
//                    ViewCenter.setVisibility(View.GONE);
...
//
//
//        if (CalenderAdapter.alistletMeChoose.contains(relative.getTag())) {
